...
function Footer() {
  return (
    <div className="md:flex md:justify-between p-6 bg-black text-white">
    <div className="mb-6 md:mb-0">
        <h2 className="mb-2 font-normal text-2xl font-lex">PAYMENT</h2>
        ...
        <div className='flex items-center p-4'>
            ...
            <div>
                <h2 className="mb-2 font-normal text-2xl font-lex">OUR WARRANTY</h2>
    ...
    <div>
        <h2 className="text-2xl mb-2 font-mako">SOCIAL MEDIA</h2>
        ...
        <h2 className="text-2xl mt-6 mb-2 font-mako">PARTNER</h2>
